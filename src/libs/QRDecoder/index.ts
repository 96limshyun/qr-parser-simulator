...
export class QRDecoder {
  ...
  detectDataAndECCPositions(matrix: number[][]) {
    const positions = [];
  ...
  detectDataPositions(matrix: number[][]) {
    ...
    return this.detectDataAndECCPositions(matrix).slice(0, maxDataBits);
  }
  ...
  detectECCPositions(matrix: number[][]) {
    ...
    return this.detectDataAndECCPositions(matrix).slice(maxDataBits);
  }
